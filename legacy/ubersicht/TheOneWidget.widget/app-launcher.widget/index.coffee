...
<li class="button" id="1">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Terminal.png">
</li>
<br>
<li class="button" id="2">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Boot Camp Assistant.png">
</li>
<br>
<li class="button" id="3">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/TextEdit.png">
</li>
<br>
<li class="button" id="4">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Stickies.png">
</li>
<br>
<li class="button" id="5">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Script Editor.png">
</li>
<br>
<li class="button" id="6">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Keychain Access.png">
</li>
<br>
<li class="button" id="7">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Automator.png">
</li>
<br>
<li class="button" id="8">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/AirPort Utility.png">
</li>
<br>
<li class="button" id="9">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Console.png">
</li>
<br>
<li class="button" id="10">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Digital Color Meter.png">
</li>
<br>
<li class="button" id="11">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Activity Monitor.png">
</li>
<br>
<li class="button" id="12">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Grapher.png">
</li>
<br>
<li class="button" id="13">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/System Information.png">
</li>
<br>
<li class="button" id="14">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Font Book.png">
</li>
<br>
<li class="button" id="15">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Disk Utility.png">
</li>
<br>
<li class="button" id="16">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/QuickTime Player.png">
</li>
<br>
<li class="button" id="17">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Calculator.png">
</li>
<br>
<li class="button" id="18">
  <img src="TheOneWidget.widget/app-launcher.widget/Icons/Dictionary.png">
</li>
"""
