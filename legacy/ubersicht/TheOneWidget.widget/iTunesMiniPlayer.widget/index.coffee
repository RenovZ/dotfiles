...
command:    "osascript `pwd`/TheOneWidget.widget/iTunesMiniPlayer.widget/iTunes.scpt"
...
update: (output, domEl) ->
    ...
    if iTunesvalues[0] != " " && iTunesvalues[1] != " "
        html = "<img src='TheOneWidget.widget/iTunesMiniPlayer.widget/images/albumart.jpg'>"
        $(domEl).find('#cover').html("")
        $(domEl).find('#cover').html(html)
    else
        $(domEl).find('#cover').html("<img src='TheOneWidget.widget/iTunesMiniPlayer.widget/images/default.png'>")
