...
if theme == 'mono' || theme == 'dark'
  ...
  fullCharge		= "TheOneWidget.widget/battery_pro.widget/icons/white_full_charge.png"
  almostFullCharge	= "TheOneWidget.widget/battery_pro.widget/icons/white_almost_charged.png"
  halfCharged		= "TheOneWidget.widget/battery_pro.widget/icons/white_half_charged.png"
  lowCharge			= "TheOneWidget.widget/battery_pro.widget/icons/low-battery.png"
  batteryCharging	= "TheOneWidget.widget/battery_pro.widget/icons/white_charging.png"
  batteryCharged	= "TheOneWidget.widget/battery_pro.widget/icons/white_full_charge.png"
  ...
  fullCharge		= "TheOneWidget.widget/battery_pro.widget/icons/black_full_charge.png"
  almostFullCharge	= "TheOneWidget.widget/battery_pro.widget/icons/black_almost_charged.png"
  halfCharged		= "TheOneWidget.widget/battery_pro.widget/icons/black_half_charged.png"
  lowCharge			= "TheOneWidget.widget/battery_pro.widget/icons/low-battery.png"
  batteryCharging	= "TheOneWidget.widget/battery_pro.widget/icons/black_charging.png"
  batteryCharged	= "TheOneWidget.widget/battery_pro.widget/icons/black_full_charge.png"
  ...
  bkground			= 'rgba(#FFF, 0.1)'
  fullCharge		= "TheOneWidget.widget/battery_pro.widget/icons/full_charge.png"
  almostFullCharge	= "TheOneWidget.widget/battery_pro.widget/icons/almost_charged.png"
  halfCharged		= "TheOneWidget.widget/battery_pro.widget/icons/half_charged.png"
  lowCharge			= "TheOneWidget.widget/battery_pro.widget/icons/low-battery.png"
  batteryCharging	= "TheOneWidget.widget/battery_pro.widget/icons/white_charging.png"
  batteryCharged	= "TheOneWidget.widget/battery_pro.widget/icons/blue_charged.png"
